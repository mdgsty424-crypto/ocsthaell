...
import { sendWithdrawalSuccessMail } from '../../services/emailService';
                        ...
                        <td colSpan={4} className="p-4 border-b border-gray-100 dark:border-gray-700">
                          <div className="space-y-3">
                            <label className="block text-sm font-medium text-gray-700 dark:text-gray-300">
                              Transaction ID (will be sent to {withdrawal.userEmail})
                            </label>
                            <input
                              type="text"
                              value={transactionId}
                            ...
                            <div className="flex justify-end gap-3">
                              ...
                              <button
                                ...
                                disabled={sendingApproval || !transactionId.trim()}
